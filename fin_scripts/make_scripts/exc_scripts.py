...
#input_file="acrolein.xyz"
	...
	exec_string="""mpiexec	--oversubscribe -np 4  python3  main.py -p $INPUTDIR -p2 $OUTPUTDIR -name ${INPUT_FILES} -num ${SLURM_ARRAY_TASK_ID} -index ${atom_index} """
