...
OUTPUTDIR=/home/${USER}/output_files/acrolein/
INPUT_FILES=acrolein.xyz
FILE_PATH=/home/singhk93/input_files/acrolein.xyz
...
mpiexec	--oversubscribe -np 4  python3  main.py -p $INPUTDIR -p2 $OUTPUTDIR -name ${INPUT_FILES} -num ${SLURM_ARRAY_TASK_ID} -index ${atom_index} 